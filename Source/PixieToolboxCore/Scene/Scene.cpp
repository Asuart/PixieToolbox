...
Scene::Scene(const std::string& name) : m_name(name) {
	...
	m_registry.emplace_or_replace<NameComponent>(m_root, NameComponent{ "root" });
	m_registry.emplace_or_replace<HierarchyComponent>(m_root);
	m_registry.emplace_or_replace<TransformComponent>(m_root);
}

Scene::Entity Scene::CreateEntity(const std::string& name) {
	return CreateEntity(name, m_root);
}
